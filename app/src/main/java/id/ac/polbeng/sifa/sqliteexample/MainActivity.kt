package id.ac.polbeng.sifa.sqliteexample
...
import id.ac.polbeng.sifa.sqliteexample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(binding.root) // Dipindahkan sebelum RecyclerView diatur
